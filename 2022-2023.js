...
const response = await fetch(
  "https://docs.google.com/spreadsheets/d/e/2PACX-1vQ7Tea-FqnCUv6fB1_6YC6tUp6ORnfYoypWLFpjnesO86BcjDIgZoLowAlyql9757mnbN41MB_nfV8y/pub?gid=0&single=true&output=csv"
);
...
const alarms = lines
  ...
  .map((line) => {
    ...
    const timestamp =
      moment(`${date} ${time}`, "MM/DD/YYYY HH:mm").toDate().getTime() / 1000;
